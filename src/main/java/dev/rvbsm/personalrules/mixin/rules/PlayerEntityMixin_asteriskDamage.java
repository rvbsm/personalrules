...
public abstract class PlayerEntityMixin_asteriskDamage {

    @WrapOperation(
        method = "isInvulnerableTo", at = @At(
    ...
    private boolean getPersonal(
        ...
        return PersonalRulesHelper.booleanOrElse((PlayerEntity) (Object) this, rule, instance, original);
    }
}
